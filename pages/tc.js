    ...
    <>
      ...
      <main className="m-auto flex max-w-5xl flex-col px-4">
        ...
        <div className="flex flex-col items-start justify-center gap-6 px-4 py-10 ">
          ...
          <p>You must not:</p>
          <ul>
            <li>Republish material from Hyperlink School</li>
            <li>Sell, rent or sub-license material from Hyperlink School</li>
            <li>Reproduce, duplicate or copy material from Hyperlink School</li>
            <li>Redistribute content from Hyperlink School</li>
          </ul>
